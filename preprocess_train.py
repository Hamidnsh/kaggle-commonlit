# -*- coding: utf-8 -*-
"""
Created on Mon Jun 21 16:07:35 2021

@author: snourashrafeddin
"""

from transformers import AutoTokenizer, AutoModel, AutoModelForMaskedLM, Trainer
import torch
import pandas as pd
...
trainer = Trainer(model=model, train_dataset=encoded_input)
trainer.train()
